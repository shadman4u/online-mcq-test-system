            ...
            if (!(isset($_SESSION['email']))) {
                ...
                echo '<span class="pull-right top title1" >
                        <span class="log1">
                         ...
                         <a href="headdash.php" class="log log1"><b>' . $email . '</b>
                         </a>
                         &nbsp;|&nbsp;<a href="logout.php?q=headdash.php" class="log">
                            <i class="bi bi-box-arrow-right custom-logo1" aria-hidden="true"></i>
                             <b>&nbsp;Signout</b></button></a></span>';
            } ?>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li <?php if (@$_GET['q'] == 0)
                        echo 'class="active"'; ?>><a href="headdash.php?q=0">Home<span
                                class="sr-only">(current)</span></a></li>
                    <li <?php if (@$_GET['q'] == 1)
                        echo 'class="active"'; ?>><a href="headdash.php?q=1">Students</a>
                    </li>
                    <li <?php if (@$_GET['q'] == 2)
                        echo 'class="active"'; ?>><a href="headdash.php?q=2">Ranking</a>
                    </li>
                    <!--
                    <li <?php if (@$_GET['q'] == 3)
                        echo 'class="active"'; ?>><a href="headdash.php?q=3">Feedback</a>
                    </li>
                    -->
                ...
                if (@$_GET['q'] == 2) {
                    ...
                    while ($row = mysqli_fetch_array($q)) {
                        ...
                        echo '<tr>
                                ...
                                <td>' . $name . '</td>
                                <td>' . $gender . '</td><td>' . $college . '</td><td>' . $s . '</td>';
                    }
                    echo '</table></div>';
                }
                ...
                <?php if (@$_GET['q'] == 1) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<tr>
                                ...
                                <td>' . $email . '</td>
                                <td>' . $mob . '</td>
	                            <td><a title="Delete User" href="update.php?demail=' . $email . '">
                                    <b><i class="bi bi-trash custom-logo1" aria-hidden="true"></i></b></a></td></tr>';
                    }
                    $c = 0;
                    echo '</table></div>';
                        ...
                        echo '<tr>
                                ...
                                <td>
                                    <a title="Delete User" href="update.php?demail1=' . $email . '">
                                        <b><i class="bi bi-trash custom-logo1" aria-hidden="true"></i></b>
                                    </a>
                                    </td>
                            </tr>';
                    }
